    ...
    <div class="flex login-container" v-if="!isMobileScreen">
      <div class="left">
        ...
        <div class="content-wrapper">
          ...
          <div class="title">NetAxe 网络自动化平台</div>
        ...
        <div class="form-wrapper">
          ...
          <div class="mt-4 item-wrapper">
            <n-input-group>
              ...
              <n-image :src="image_url" @click="get_captcha()" preview-disabled />
            </n-input-group>
          </div>
          <div class="mt-6">
...
<script lang="ts">
  ...
  import { login, captcha } from '@/api/url'
    ...
    setup() {
      ...
      function get_captcha() {
        get({
          ...
          // console.log(res)
          image_url.value = res.data['image_base']
          captchaKey.value = res.data['key']
        })
      }
      onMounted(get_captcha)
      return {
        image_url,
        captchaKey,
        captchaValue,
